...
export const metadata: Metadata = {
  title: "O que ela vê, você aprova [v3/visao]",
  description:
    "A Soul Genia acompanha conversas, áudios, agenda e contas de dentro do seu WhatsApp, resume o que pede resposta e deixa mensagens agendadas. Antes de qualquer envio, a decisão passa por você.",
  robots: {
    index: false,
    follow: false,
  },
...
export default function SoulGeniaHomePage() {
  const heroArtAlt =
    "Vista por cima do ombro da Soul Genia diante de painéis escuros de WhatsApp com resumos de conversas, pendências separadas e um cartão pedindo aprovação de envio";

  const {
    props: { srcSet: heroArtDesktopSrcSet },
  } = getImageProps({
    alt: heroArtAlt,
    src: "/images/heroes/v3/visao-desktop.webp",
    width: 1672,
    height: 700,
    sizes: "100vw",
    priority: true,
  ...
  const {
    ...
    alt: heroArtAlt,
    src: "/images/heroes/v3/visao-mobile.webp",
    width: 940,
    height: 700,
    sizes: "100vw",
    priority: true,
  ...
  return (
    <main className="bg-background text-foreground">
      <LandingAnalytics page="soul_genia_v3_visao" />

      <section className="relative isolate flex min-h-svh flex-col overflow-hidden bg-[var(--v3-visao-bg)] text-white">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(92rem_46rem_at_14%_-8%,color-mix(in_srgb,var(--v3-visao-navy-core)_85%,transparent),transparent_64%)]"
        />
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(48rem_26rem_at_82%_12%,color-mix(in_srgb,var(--v3-visao-accent)_16%,transparent),transparent_68%)]"
        />
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-10 pt-28 sm:px-8 md:pb-14 md:pt-32">
          <div className="hero-copy max-w-3xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[color-mix(in_srgb,var(--v3-visao-accent)_36%,transparent)] bg-white/8 px-4 py-2 text-sm font-semibold text-white/90 backdrop-blur">
              <span className="aura-dot h-2 w-2 rounded-full bg-[var(--v3-visao-accent)]" />
              Nada sai sem você ver
            </div>

            <h1 className="max-w-4xl text-[clamp(2.6rem,10.5vw,5.6rem)] font-display leading-[0.95] tracking-tight text-white md:text-[clamp(3.5rem,6.4vw,5.6rem)]">
              O que ela vê, você aprova.
            </h1>

            <p className="mt-6 max-w-2xl text-base leading-7 text-white/84 sm:text-lg sm:leading-8">
              A Soul Genia acompanha conversas, áudios, agenda e contas de
              dentro do seu WhatsApp. Ela resume o que aconteceu, separa o que
              pede resposta e deixa mensagens agendadas para o horário certo.
              Antes de qualquer envio, a decisão passa por você.
            </p>
            ...
            <ul className="mt-7 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm font-medium text-white/66">
              {[
                "Resumos claros de cada conversa",
                "Pendências separadas do ruído",
                "Envio só depois do seu ok",
              ].map((point) => (
                <li key={point} className="inline-flex items-center gap-2">
                  <span
                    aria-hidden
                    className="h-1.5 w-1.5 rounded-full bg-[var(--v3-visao-accent)]"
                  />
                  {point}
                </li>
              ))}
        ...
        <div className="relative z-0 mt-auto w-full">
          <picture>
            ...
            <img
              ...
              alt={heroArtAlt}
              fetchPriority="high"
              className="block h-[clamp(230px,40svh,700px)] w-full object-cover object-bottom"
            />
          </picture>
          <div
            aria-hidden
            className="pointer-events-none absolute inset-x-0 top-0 h-[55%] bg-[linear-gradient(to_bottom,var(--v3-visao-bg)_0%,color-mix(in_srgb,var(--v3-visao-bg)_78%,transparent)_34%,transparent_100%)]"
          />
          <div aria-hidden className="pointer-events-none absolute inset-x-0 bottom-0 h-[8%] bg-[linear-gradient(to_top,var(--v3-visao-bg),transparent)] md:hidden" />
        </div>
      </section>
