...
export const metadata: Metadata = {
  title: "Soul Genia | Secretária pessoal no WhatsApp",
  description:
    "Soul Genia organiza sua vida pessoal e profissional pelo WhatsApp, com lembretes, briefings, resumos, mensagens agendadas e aprovação antes de enviar.",
  robots: {
    index: true,
    follow: true,
  },
...
export default function SoulGeniaHomePage() {
  return (
    <main className="bg-background text-foreground">
      <LandingAnalytics page="soul_genia_personal_secretary" />

      <section className="v21-hero-shell relative overflow-hidden bg-primary text-white">
        <div className="v21-hero-grid absolute inset-0" />
        <div className="v21-hero-glow absolute inset-0" />
        ...
        <div className="absolute inset-x-0 top-0 z-20">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
            ...
            <TrackedCtaLink
              ...
              className="motion-press shine-pass hidden min-h-11 items-center rounded-full bg-primary-light px-5 py-2.5 text-sm font-semibold text-white shadow-[0_10px_40px_-10px_rgba(13,170,191,0.55)] hover:bg-primary-lighter md:inline-flex"
            >
        ...
        <div className="relative z-10 mx-auto grid min-h-[78svh] max-w-7xl items-end gap-8 px-5 pb-8 pt-28 sm:px-8 md:min-h-[82svh] lg:grid-cols-[0.96fr_1.04fr] lg:items-center lg:gap-12 lg:pb-10">
          <div className="hero-copy max-w-3xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-semibold text-white/90 backdrop-blur">
              <span className="aura-dot h-2 w-2 rounded-full bg-green-400" />
              Onboarding assistido aberto
            </div>

            <h1 className="max-w-4xl text-[clamp(2.65rem,11vw,6.5rem)] font-display leading-[0.95] tracking-tight text-white md:text-[clamp(3.9rem,7.4vw,6.5rem)]">
              Sua secretária pessoal dentro do WhatsApp.
            </h1>

            <p className="mt-6 max-w-2xl text-base leading-7 text-white/84 sm:text-xl sm:leading-9">
              Uma secretária pessoal no seu WhatsApp para transformar conversas,
              áudios, agenda e lembretes em uma rotina mais leve: ela organiza
              mensagens, compromissos, contas e prioridades do dia, sempre com
              você no controle antes de qualquer envio.
            </p>
          ...
          <div className="v21-portrait-stage justify-self-center lg:justify-self-end">
            <div className="v21-portrait-card">
              <Image
                src="/images/auria-hero-face-v21.png"
                alt="Retrato editorial da Soul Genia"
                width={1024}
                height={1280}
                priority
                className="v21-portrait-image"
                sizes="(min-width: 1024px) 42vw, 86vw"
              />
              <div className="v21-portrait-label">
                <p className="text-xs font-bold uppercase tracking-[0.16em] text-primary-light">
                  Soul Genia
                </p>
                <p className="mt-1 text-sm text-white/70">
                  Secretária pessoal no WhatsApp
                </p>
              </div>
            </div>

            <div className="v21-flow-ticket">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary-light">
                  Como começa
                </p>
                <p className="mt-1 text-xl font-display text-white">
                  Conversa pelo WhatsApp
                </p>
              </div>
              <p className="mt-3 text-sm leading-6 text-white/64">
                Você chama, explica sua rotina e a Soul Genia começa ajudando
                com lembretes, resumos, mensagens agendadas e próximos passos.
              </p>
            </div>
          </div>
        </div>
